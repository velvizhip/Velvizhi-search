...
const tableData = [{fname: 'Velvizhi', lname: 'Palanisamy', 'email': 'vel@aa.com'}, {fname: 'Priya', lname: 'S', 'email': 'priya@hopmail.com'}, {fname: 'Sam', lname: 'Pari', 'email': 'sam@aa.com'}, {fname: 'Ragu', lname: 'Vari', 'email': 'ragu@aa.com'}];
